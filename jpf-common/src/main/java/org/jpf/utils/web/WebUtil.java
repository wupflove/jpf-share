 ...
 *
 */
public final class WebUtil extends abstractUtil{
	 ...
	 * 
	 * @param cErrorMsg CBSErrorMsg 从业务调用中获得的错误对象
	 * 
	 * @param iGuiType int 错误信息页中显示的按钮类型，1，返回；2，确定（重定向到其他页）
	 * 
	 * @param strActionUrl String 重定向到其他页的url，该参数需要iGuiType=2
	 */

	public static void set_commonErr(HttpServletRequest request, HttpServletResponse response, String sErrMsg,
...

	{
...

		{
			...
			request.getRequestDispatcher("/commons/common_errorPage.jsp").forward(request, response);
	...
	public static void set_commonErr(HttpServletRequest request, HttpServletResponse response, String sErrMsg,
			String sErrDetail, int iGuiType, String strActionUrl)
	 ...
	 * @param strErrMsg
	 * @author wupf
	 * @Date :2020年11月24日上午9:13:02
	 */
	public static void set_commonErr(HttpServletRequest request, HttpServletResponse response, String strErrMsg) {
		set_commonErr(request, response, strErrMsg, 2, "javascript:history.back()");
		return;
	 ...
	 * @return String
	 */
	public static int getRequestForInt(HttpServletRequest request, String strRequest) {
