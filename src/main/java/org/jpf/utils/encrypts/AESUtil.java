 ...
 * Description: aes加密工具
 *
 * @author wupf 2019/06/08.
 */
public class AESUtil extends abstractUtil {
	...
	public static String encodeByECB(String content, String key) {
		...
		try {
			...
			// BASE64 is used here as a transcoding function, which can also play a role of
			// 2 times encryption
	...
	private static void checkParamsOfCBC(String content, String key, String initVector) {
		AESUtil.checkContentAndKey(content, key);
		if (JpfStringUtil.isEmpty(initVector)) {
