 ...
 *
 */
public class JpfValidateUtil {

	private JpfValidateUtil() {
	}
	...
	public static final String IDCARD_PATTERN = "^((11|12|13|14|15|21|22|23|31"
			+ "|32|33|34|35|36|37|41|42|43|44|45|46|50|51|" + "52|53|54|61|62|63|64|65|71|81|82|91)\\d{4})"
			+ "((((19|20)(([02468][048])|([13579][26]))0229))|" + "((20[0-9][0-9])|(19[0-9][0-9]))((((0[1-9])|(1[0-2]))"
			+ "((0[1-9])|(1\\d)|(2[0-8])))|((((0[1,3-9])" + "|(1[0-2]))(29|30))|(((0[13578])|(1[02]))31))))"
			+ "((\\d{3}(x|X))|(\\d{4}))$";
	...
	public static final String[] forbidden = { "\\bselect\\b", "\\bor\\b", "\\bdelete\\b", "\\bjoin\\b", "\\btable\\b",
			"\\bdrop\\b", "\\biframe\\b", "\\bwindow\\b", "\\b_\\b", "\\+", "%", "\\<", "\\>", "'", "=", "%3C", "\\(",
			"%28", "alert", "eval((.*))", "script", "location.href" };
	...
	public static boolean validate(String str, String pattern) {
		return JpfStringUtil.isNotEmpty(str) && str.matches(pattern);
	}
	...
	/**
	 * validate Chinese Moble phone number the number include start with 13,15,18
	 *
	 * @param phone String
	 * @return boolean
	 */
	...
	public static boolean isNotTelephone(String phoneNumber) {
		return !JpfValidateUtil.isTelephone(phoneNumber);
	}
	...
	/**
	 * Verify that it is a valid uuid, If you remove the "-" you must also have a 32-bit length.
	 * 
	 * @param str String
	 * @return boolean
	 */
	...
	public static boolean isNotIP(String ip) {
		return !JpfValidateUtil.isIP(ip);
	}

	/**
	 * Verify that it is a valid url address and does not support Chinese. Usage:
	 * https://www.baidu.com:8080/a/n?a=5， https://192.168.15.96:8080/a/n?a=5
	 *
	...
	/**
	 * Verify that the domain name is valid. Can only be a standard domain name like www.baidu.com.
	 *
	 * @param domain domain
	 * @return boolean
	 */
	...
	public static boolean isContainsForbiddenCharacter(String number) {
		if (JpfStringUtil.isEmpty(number)) {
			return false;
		} else {
